...
function FloatingCharacter({ character, translateEndX = 0, translateEndY = 0, rotateEnd = 0, scrollStart = 0, scrollLength = 1e3 }) {
  ...
  if (character == " ") return /* @__PURE__ */ jsx("span", { className: "flex h-full w-5 xl:w-15 will-change-transform" });
  return /* @__PURE__ */ jsx("span", { ref: letterRef, className: `letter text-[60px] sm:text-[90px] md:text-[120px] lg:text-[150px] xl:text-[210px] font-semibold flex items-center justify-center will-change-transform`, children: character });
}
...
var FloatingCharacterLine = ({ text, yMax = 2500, yMin = 2e3, xMax = 10, xMin = 10, rot = 30, scrollStart = 0, scrollLength = 1e3 }) => {
  ...
  return /* @__PURE__ */ jsx2("div", { className: "flex flex-wrap relative", children: words.map((word, index) => /* @__PURE__ */ jsxs("div", { className: "flex", children: [
    word.split("").map((char, innerIndex) => /* @__PURE__ */ jsx2(
...
function BouncyAttractor({
  ...
  const bouncyAttractorRef = useRef2(null);
  useEffect2(() => {
  ...
  return /* @__PURE__ */ jsx3("div", { ref: bouncyAttractorRef, className: "pointer-events-none *:pointer-events-auto", children });
}
  ...
  return /* @__PURE__ */ jsxs2(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx4("div", { className: "absolute inset-0 w-full h-full -z-20", style: { backgroundColor: `${color}` } })
      ]
    }
  );
}
...
export {
  BouncyAttractor_default as BouncyAttractor,
  CancelSmoothScroll,
  FloatingCharacter_default as FloatingCharacter,
  FloatingCharacterLine_default as FloatingCharacterLine,
  InkDropButton_default as InkDropButton,
  SmoothScroll
};
